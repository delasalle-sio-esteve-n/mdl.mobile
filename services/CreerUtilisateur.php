...
{	// redéclaration des données globales utilisées dans la fonction
	...
	$sujet = "Cr�ation de votre compte dans le syst�me de r�servation de M2L";
	$message = "L'administrateur du système de réservations de la M2L vient de vous créer un compte utilisateur.\n\n";
	$message .= "Les donn�es enregistr�es sont :\n\n";
	...
	$message .= "Votre niveau d'accès (0 : invit�    1 : utilisateur    2 : administrateur) : " . $level . "\n";
